...
[`reticulate::iterate()`](https://rstudio.github.io/reticulate/reference/iterate.md)
...
- Many numpy operations modify the array in place! This is surprising to
  ...
  [`reticulate::repl_python()`](https://rstudio.github.io/reticulate/reference/repl_python.md).
