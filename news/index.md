...
- Fix error in
  [`virtualenv_create()`](https://rstudio.github.io/reticulate/reference/virtualenv-tools.md)/[`virtualenv_starter()`](https://rstudio.github.io/reticulate/reference/virtualenv-tools.md)
...
- [`py_register_load_hook()`](https://rstudio.github.io/reticulate/reference/py_register_load_hook.md)
...
- Output of
  [`reticulate::py_last_error()`](https://rstudio.github.io/reticulate/reference/py_last_error.md)
...
- [`is_py_object()`](https://rstudio.github.io/reticulate/reference/is_py_object.md)
  is now exported
...
- The search that reticulate conducts to select which Python
  ...
  [`vignette("versions", package = "reticulate")`](https://rstudio.github.io/reticulate/articles/versions.md).

- Updated recommendations in the “python_dependencies” vignette for how
  R packages can approach Python dependency management.
  [`vignette("python_dependencies", package = "reticulate")`](https://rstudio.github.io/reticulate/articles/python_dependencies.md)
...
- `reticulate` gains
  [`reticulate::conda_update()`](https://rstudio.github.io/reticulate/reference/conda-tools.md),
  for updating the version of `conda` in a particular `conda`
  installation.

- `reticulate` gains
  [`reticulate::miniconda_uninstall()`](https://rstudio.github.io/reticulate/reference/miniconda_uninstall.md),
  for uninstalling the reticulate-managed version of Miniconda.
  ([\#1077](https://github.com/rstudio/reticulate/issues/1077))

- [`reticulate::use_python()`](https://rstudio.github.io/reticulate/reference/use_python.md)
...
- The default version of Python used for the `r-reticulate` Miniconda
  ...
  [`reticulate::install_miniconda()`](https://rstudio.github.io/reticulate/reference/install_miniconda.md)
...
- [`reticulate::conda_create()`](https://rstudio.github.io/reticulate/reference/conda-tools.md)
...
- Fixed an issue where
  [`reticulate::conda_install()`](https://rstudio.github.io/reticulate/reference/conda-tools.md)
...
- The function
  [`py_help_handler()`](https://rstudio.github.io/reticulate/reference/py_help_handler.md)
...
- [`reticulate::import_from_path()`](https://rstudio.github.io/reticulate/reference/import.md)
...
- [`reticulate::virtualenv_create()`](https://rstudio.github.io/reticulate/reference/virtualenv-tools.md)
...
- Fixed an issue where
  [`reticulate::configure_environment()`](https://rstudio.github.io/reticulate/reference/configure_environment.md)
...
- [`reticulate::py_install()`](https://rstudio.github.io/reticulate/reference/py_install.md)
...
- [`reticulate::use_condaenv()`](https://rstudio.github.io/reticulate/reference/use_python.md)
...
- reticulate will now attempt to bind to `python3` rather than `python`,
  ...
  e.g. [`use_python()`](https://rstudio.github.io/reticulate/reference/use_python.md).
...
- `reticulate` now provides a mechanism for allowing client packages to
  ...
  [`vignette("python_dependencies")`](https://rstudio.github.io/reticulate/articles/python_dependencies.md)
  for more details.
...
- reticulate now warns if it did not honor the user’s request to load a
  ...
  e.g. [`reticulate::use_python()`](https://rstudio.github.io/reticulate/reference/use_python.md).
...
- Add
  ...
  amd
  [`py_function_wrapper()`](https://rstudio.github.io/reticulate/reference/py_function_wrapper.md)
...
- Added ability to customize mapping of Python classes to R classes via
  ...
  [`import()`](https://rstudio.github.io/reticulate/reference/import.md)
  and the
  [`register_class_filter()`](https://rstudio.github.io/reticulate/reference/register_class_filter.md)
  function
