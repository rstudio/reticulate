...
register_help_topics("module", help_topics("framework.html", "tensorflow", c(
  "Graph",
  "Operation",
  "Tensor",
  "DType",
...
register_help_topics("module", help_topics("constant_op.html", "tensorflow", c(
  "zeros",
  "zeros_like",
  "ones",
  "ones_like",
...
register_help_topics("module", help_topics("state_ops.html", "tensorflow", c(
    "Variable",
    "all_variables",
    "trainable_variables",
    "local_variables",
...
register_help_topics("module", help_topics("state_ops.html", "tensorflow.python.training.training", c(
  "Saver",
  "latest_checkpoint",
...
register_help_topics("module", help_topics("array_ops.html", "tensorflow", c(
  "string_to_number",
  "to_double",
  "to_float",
  "to_bfloat16",
...
register_help_topics("module", help_topics("math_ops.html", "tensorflow", c(
  "add",
  "sub",
  "mul",
  "div",
...
register_help_topics("module", help_topics("control_flow_ops.html", "tensorflow", c(
  "identity",
  "tuple",
  "group",
  "no_op",
...
register_help_topics("module", help_topics("image.html", "tensorflow.python.ops.image_ops", c(
  "decode_jpeg",
  "encode_jpeg",
  "decode_png",
  "encode_png",
...
register_help_topics("module", help_topics("sparse_ops.html", "tensorflow", c(
  "SparseTensor",
  "SparseTensorValue",
  "sparse_to_dense",
...
register_help_topics("module", help_topics("io_ops.html", "tensorflow", c(
  "placeholder",
...
register_help_topics("module", help_topics("io_ops.html", "tensorflow.python.training.training", c(
...
register_help_topics("module", help_topics("python_io.html", "tensorflow.python.lib.io.python_io", c(
  "TFRecordWriter",
  "tf_record_iterator"
)))

register_help_topics("module", help_topics("nn.html", "tensorflow.python.ops.nn", c(
  "relu",
  "relu6",
  "elu",
  "softplus",
...
register_help_topics("module",  help_topics("client.html", "tensorflow", c(
  "Session",
  "InteractiveSession",
  "get_default_session",
  "OpError"
...
register_help_topics("module", help_topics("client.html", "tensorflow.python.framework.errors", c(
  "OpError",
  "CancelledError",
  "UnknownError",
...
register_help_topics("module", help_topics("train.html", "tensorflow.python.training.training", c(
  "Optimizer",
...
register_help_topics("module", help_topics("train.html", "tensorflow", c(
  "gradients",
  "AggregationMethod",
  "stop_gradient",
  "clip_by_value",
...
register_help_topics("module", help_topics("train.html", "tensorflow.python.ops.nn", c(
  "zero_fraction"
)))

register_help_topics("module", help_topics("script_ops.html", "tensorflow", c(
  "py_func"
)))

register_help_topics("module", help_topics("test.html", "tensorflow.python.platform.test", c(
  "main",
...
register_help_topics("module", help_topics("contrib.layers.html", "tensorflow.contrib.layers", c(
  "avg_pool2d",
  "batch_norm",
  "convolution2d",
...
register_help_topics("module", help_topics("contrib.losses.html", "tensorflow.contrib.losses", c(
  "absolute_difference",
  "add_loss",
  "cosine_distance",
  "get_losses",
...
register_help_topics("module", help_topics("contrib.metrics.html", "tensorflow.contrib.metrics", c(
  "streaming_accuracy",
  "streaming_mean",
  "streaming_recall",
  "streaming_precision",
...
register_help_topics("module", help_topics("contrib.learn.html", "tensorflow.contrib.learn", c(
  "BaseEstimator",
  "Estimator",
  "ModeKeys",
...
register_help_topics("module", help_topics("contrib.framework.html", "tensorflow.contrib.framework", c(
...
register_help_topics("module", help_topics("contrib.framework.html", "tensorflow", c(
  "is_numeric_tensor",
  "is_non_decreasing",
  "is_strictly_increasing"
)))

register_help_topics("module", help_topics("contrib.util.html", "tensorflow.contrib.util", c(
  "constant_value",
  "make_tensor_proto",
  "make_ndarray",
...
register_help_topics("class", help_topics("framework.html", "tensorflow.python.framework", c(
  "ops.Graph",
  "ops.Operation",
  "ops.Tensor",
  "dtypes.DType",
...
register_help_topics("class", help_topics("state_ops.html", "tensorflow.python", c(
...
register_help_topics("class", help_topics("sparse_ops.html", "tensorflow.python.framework.ops", c(
  "SparseTensor",
  "SparseTensorValue"
)))

register_help_topics("class", help_topics("io_ops.html", "tensorflow.python.ops.io_ops", c(
  "BaseReader",
  "TextLineReader",
  "WholeFileReader",
  "IdentityReader",
...
register_help_topics("class", help_topics("io_ops.html", "tensorflow.python.ops.data_flow_ops", c(
  "QueueBase"
)))

register_help_topics("class", help_topics("python_io.html", "tensorflow.python.lib.io", c(
  "tf_record.TFRecordWriter"
)))

register_help_topics("class", help_topics("client.html", "tensorflow.python.client.session", c(
  "Session"
)))

register_help_topics("class", help_topics("client.html", "tensorflow.python.framework.errors", c(
  "OpError"
)))

register_help_topics("class", help_topics("train.html", "tensorflow.python.training", c(
  "optimizer.Optimizer",
...
register_help_topics("class", help_topics("contrib.learn.html", "tensorflow.contrib.learn.python.learn.estimators", c(
  "BaseEstimator",
  "Estimator",
  "ModeKeys",
  "dnn.DNNClassifier",
