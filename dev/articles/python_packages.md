...
[version](https://rstudio.github.io/reticulate/dev/articles/versions.md)
vignette.
...
- On all platforms, you can use
  [`reticulate::install_python()`](https://rstudio.github.io/reticulate/dev/reference/install_python.md).
