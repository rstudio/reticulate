...
The tensorflow R package provides access to the complete [TensorFlow API](https://www.tensorflow.org/api_docs/python/index.html) from within R. This article describes the basic syntax and mechanics of using TensorFlow from R.
