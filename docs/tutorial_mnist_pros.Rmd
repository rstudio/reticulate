...
You can copy and paste each code snippet from this tutorial into an R environment, or you can choose to just read through the code. You can also download this tutorial as an R Markdown document using the **Code** menu at the top of the document.
