...
converted back to R types. The reticulate package is compatible with all
versions of Python \>= 3.6. Integration with NumPy requires NumPy
...
- Yuan Tang <terrytangyuan@gmail.com>
  ([ORCID](https://orcid.org/0000-0001-5243-233X)) \[copyright holder\]
...
- Marcus Geelnard (TinyThread library,
  http://tinythreadpp.bitsnbites.eu/) \[contributor, copyright holder\]
