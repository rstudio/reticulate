...
1. By setting the value of the `RETICULATE_PYTHON` environment variable to a Python binary. Note that if you set this environment variable then the specified version of Python will always be used (i.e. this is prescriptive rather than advisory).
