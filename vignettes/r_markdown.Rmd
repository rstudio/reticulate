...
The **reticulate** package includes a Python engine for [R Markdown](http://rmarkdown.rstudio.com) that enables easy interoperability between Python and R chunks. 
...
[RStudio v1.2](https://rstudio.com/products/rstudio/download/) or greater for reticulate IDE support.
