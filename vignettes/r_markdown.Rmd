...
Note that the [daily build](https://dailies.rstudio.com) of RStudio includes support for using reticulate to execute Python chunks within R Notebooks. See the [RStudio IDE Tools for reticulate](rstudio_ide.html) article for additional details.
