...
![reticulated python](reference/figures/reticulated_python.png)
...
By default, reticulate uses an isolated python virtual environment named
“r-reticulate”.
...
2.  [Importing Python modules](#importing-python-modules) — The
    ...
    function enables you to import any Python module and call it’s
...
3.  [Sourcing Python scripts](#sourcing-python-scripts) — The
    ...
    function enables you to source a Python script the same way you
    would [`source()`](https://rdrr.io/r/base/source.html) an R script
    (Python functions and objects defined within the script become
    directly available to the R session).

4.  [Python REPL](#python-repl) — The
    [`repl_python()`](https://rstudio.github.io/reticulate/dev/reference/repl_python.md)
    function creates an interactive Python console within R. Objects you
    create within Python are available to your R session (and
    vice-versa).
...
![](reference/figures/rmarkdown_engine_zoomed.png)
...
You can use the
[`import()`](https://rstudio.github.io/reticulate/dev/reference/import.md)
function to import any Python module and call it from R. For example,
this code imports the Python `os` module and calls the `listdir()`
function:
...
![](reference/figures/reticulate_completion.png)
...
using the
[`source_python()`](https://rstudio.github.io/reticulate/dev/reference/source_python.md)
function. For example, if you had the following Python script
*flights.py*:
...
Objects created within the Python REPL can be accessed from R using the
`py` object exported from reticulate. For example:

![](reference/figures/python_repl.png)
...
using the `r` object (e.g. `r.flights`). See the
[`repl_python()`](https://rstudio.github.io/reticulate/dev/reference/repl_python.md)
...
- [R Markdown Python
  Engine](https://rstudio.github.io/reticulate/articles/r_markdown.html)
  — Provides details on using Python chunks within R Markdown documents,
  including how call Python code from R chunks and vice-versa.

- [Python Version
  Configuration](https://rstudio.github.io/reticulate/articles/versions.html)
  — Describes facilities for determining which version of Python is used
  by reticulate within an R session.

- [Installing Python
  Packages](https://rstudio.github.io/reticulate/articles/python_packages.html)
  — Documentation on installing Python packages from PyPI or Conda, and
  managing package installations using virtualenvs and Conda
  environments.

- [Using reticulate in an R
  Package](https://rstudio.github.io/reticulate/articles/package.html) —
  Guidelines and best practices for using reticulate in an R package.

- [Arrays in R and
  Python](https://rstudio.github.io/reticulate/articles/arrays.html) —
  Advanced discussion of the differences between arrays in R and Python
  and the implications for conversion and interoperability.
