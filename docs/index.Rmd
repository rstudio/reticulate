...
Once you've succesfully installed and TensorFlow and verified that it's working correctly, you can install the **tensorflow** R package as follows:

```{r, eval=FALSE}
devtools::install_packages("jjallaire/tensorflow")
```
...
You can also find additional tutorials and documentation on the main [TensorFlow website](https://tensorflow.org). This documentation uses the Python API, however since the R API is nearly identical to the Python API the content is easy to adapt for use with R.
