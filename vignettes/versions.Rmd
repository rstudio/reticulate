...
4.  If the environment variable `VIRTUAL_ENV` is defined (typically from running an `activate` script before R started), then the Python from the activated environment is used.
