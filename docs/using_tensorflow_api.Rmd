...
- Some APIs call for shapes, which are lists of integers that can include `NULL` for dimensions that can have any number of elements. For this use e.g. `list(NULL, 10L)` (since `c(NULL, 10L)` would drop the `NULL`).
