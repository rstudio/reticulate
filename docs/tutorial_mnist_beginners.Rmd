...
*This tutorial is intended for readers who are new to both machine learning and TensorFlow. If you already know what MNIST is, and what softmax (multinomial logistic) regression is, you might prefer this [faster paced tutorial](tutorial_mnist_pros.md). Be sure to [install TensorFlow](https://www.tensorflow.org/get_started/) before starting either tutorial.*
