...
When you train a model, you use [variables](https://www.tensorflow.org/api_docs/python/state_ops.html)
...
*  The [`tf$Variable`](https://www.tensorflow.org/api_docs/python/state_ops.html#Variable) class.
*  The [`tf$train$Saver`](https://www.tensorflow.org/api_docs/python/state_ops.html#Saver) class.


## Creation

When you create a [Variable](https://www.tensorflow.org/api_docs/python/state_ops.html) you pass a
...
from [constants or random values](https://www.tensorflow.org/api_docs/python/constant_op.html).
...
[`with(tf$device(...), {})`](https://www.tensorflow.org/api_docs/python/framework.html#device) block:
...
[`v$assign()`](https://www.tensorflow.org/api_docs/python/state.html#Variable.assign) and the parameter
update operations in a
[`tf$train$Optimizer`](https://www.tensorflow.org/api_docs/python/train.html#Optimizer) *must* run on
...
setting. See
[`tf$train$replica_device_setter()`](https://www.tensorflow.org/api_docs/python/train.html#replica_device_setter)
...
[Variables Documentation](https://www.tensorflow.org/api_docs/python/state_ops.html) for more options,
...
[`Variable.name`](https://www.tensorflow.org/api_docs/python/state_ops.html#Variable.name) property for
each variable.
...
`tf$train$Saver()` constructor a named list with the appropirate names and values.
...
*  If you only restore a subset of the model variables at the start
   ...
   [`tf$initialize_variables()`](https://www.tensorflow.org/api_docs/python/state_ops.html#initialize_variables)
