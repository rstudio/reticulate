...
The tensorflow R package provides access to the complete [TensorFlow API](https://www.tensorflow.org/api_docs/python/index.html) from within R. Here's a simple example of making up some data in two dimensions and then fitting a line to it:
