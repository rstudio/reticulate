...
The tensorflow package provides access to the complete TensorFlow API from within R.  This article describes the basic mechanics of using the R API. For a detailed API reference, see the main [TensorFlow API](https://www.tensorflow.org/versions/r0.10/api_docs/python/index.html) documentation. 
