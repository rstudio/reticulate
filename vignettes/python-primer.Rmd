...
R is commonly used for statistics and data analysis, but it is not the
only language on the scene. You may find yourself occasionally wanting
to read and understand some Python, or even port some Python to R. This
guide is designed to enable you to do these tasks as quickly as
