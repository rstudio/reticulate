...
* On Mac OS X you should NOT install TensorFlow with Anaconda as there [are issues with](https://github.com/ContinuumIO/anaconda-issues/issues/498) the way Anaconda builds the python shared library that prevent dynamic linking from R. We recommend using [Homebrew Python](http://docs.python-guide.org/en/latest/starting/install/osx/) instead.
