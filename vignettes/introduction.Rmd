...
![](images/completion-functions.png){width=690 height=223 style="margin-bottom: 15px; border: solid 1px #cccccc;"}

Inline help is also available for function parameters:

![](images/completion-params.png){width=690 height=152 style="margin-bottom: 15px; border: solid 1px #cccccc;"}
